using System;
// On exceeding requirements , I tried to keep a log fo how many times activities were performed. 
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Welcome to the Mindfulness Program! Enjoy the experience.");
        Console.WriteLine();
        bool running = true;
        while (running)
        {
