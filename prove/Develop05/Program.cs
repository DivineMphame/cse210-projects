using System;
// On exceeding requirements, I added asking the user if they would like to save their goals before they quit.
// I made sure that no additional points were rewarded if completed goals were attempted to be recorded again. 
class Program
{
